...
@interface InerAchievViewController ()
...
@implementation InerAchievViewController{
...
- (void)viewDidLoad
{
    ...
    nameArray = [[NSMutableArray alloc]initWithArray:[icc getInterirorAchievements:self.myData] ];
    NSLog(@"%@",nameArray);
